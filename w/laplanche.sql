...
INSERT INTO `courts` (`id`, `name`, `address`, `postal_code`, `city`, `picture`, `description`, `net`, `court-state`, `opening_hours`, `admin_validation`, `parking`) VALUES
(1, 'City Stade Brun', '63 Rue Brun ', 33000, 'Bordeaux', '', '1 terrain multisports handball et basket-ball (Equipement de plein air)', 0, '', '7 jours/7 de 8h00 à 22h00', 0, 0),
