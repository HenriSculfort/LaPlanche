...
class ChatController extends Controller
{
    ...
    public function addMessageAjax() { 
        ...
        if(!empty($_GET)) { 
            ...
            /* Liste des mots exclus du chat*/ if(preg_match('#connard|enculé|connasse|pute|pd|pédé|fdp|salope|bite|trouduc|défoncer|enculés|enculer|batard|poufiasse|pouffiasse|ntm|merde|merdes|fuck|vttf|tg|pétasse|enfoiré#', $get['message']))
            {
